...
export default function AdvertisingDetailsArea() {
    const settingBanner = {
        ...
        photos: [
          ...
          { source: "/images/services/banner/banner1.jpg" },
          { source: "/images/services/banner/banner2.jpg" },
          { source: "/images/services/banner/banner3.jpg" },
          { source: "/images/services/banner/banner4.jpg" },
      ...
      const settingTarp = {
        ...
        photos: [
          ...
          { source: "/images/services/tarp/tarp1.jpg" },
          { source: "/images/services/tarp/tarp2.jpg"},
      ...
      const settingPortabooth = {
        width: '100%',
        height: ['150px', '270px'],
        layout: [1, 3],
        photos: [
      
          { source: "/images/services/portabooth/porta1.jpg" },
          { source: "/images/services/portabooth/porta2.jpg" },
      ...
      const settingWallskin = {
        width: '100%',
        height: ['150px', '270px'],
        layout: [1, 3],
        photos: [
      
          { source: "/images/services/wallskin/wallskin1.jpg" },
          { source: "/images/services/wallskin/wallskin2.jpg" },
          { source: "/images/services/wallskin/wallskin3.jpg"  },
      ...
      const settingCanvas = {
        ...
        photos: [
          ...
          { source: "/images/services/canvas/canvas1.jpg" },
          { source:  "/images/services/canvas/canvas2.jpg"  },
          { source:  "/images/services/canvas/canvas3.jpg"  },
          { source:  "/images/services/canvas/canvas4.jpg"  },
      ...
      const settingDiecut = {
        ...
        photos: [
          ...
          { source: "/images/services/diecut/diecut1.jpg" },
          { source: "/images/services/diecut/diecut2.jpg"  },
          { source: "/images/services/diecut/diecut3.jpg"  },
      ...
      const settingCarstickers = {
        width: '100%',
        height: ['150px', '270px'],
        layout: [1, 3],
        photos: [
      
          { source: "/images/services/car/car1.jpg" },
          { source: "/images/services/car/car2.jpg"  },
          { source: "/images/services/car/car3.jpg"  },
          { source: "/images/services/car/car4.jpg"  },
      ...
      const settingFrosted = {
        width: '100%',
        height: ['150px', '270px'],
        layout: [1, 3],
        photos: [
      
          { source: "/images/services/frosted/frosted1.jpg" },
          { source: "/images/services/frosted/frosted2.jpg"  },
          { source: "/images/services/frosted/frosted3.jpg"  },
      ...
      const settingVinyl = {
        ...
        photos: [
          ...
          { source: "/images/services/vinyl/vinyl1.jpg" },
          { source: "/images/services/vinyl/vinyl2.jpg"  },
          { source: "/images/services/vinyl/vinyl3.jpg"  },
      ...
      const settingReflect = {
        width: '100%',
        height: ['150px', '270px'],
        layout: [1, 3],
        photos: [
      
          { source: "/images/services/reflectorized/reflectorized1.jpg" },
          { source: "/images/services/reflectorized/reflectorized2.jpg"  },
                ...
                <div className="container">
                    ...
                    <div className="cat" style={{  textAlign: 'center', marginBottom:'50px'}}>
                        ...
                        style={{
                            backgroundColor: '#0072f5',borderRadius:'25px'
                                   ...
                                   <ReactPhotoCollage {...settingBanner} />
                      ...
                      Portabooth
                        ...
                        style={{  backgroundColor: '#d56b60',borderRadius:'25px'}}>
                                    <ReactPhotoCollage {...settingPortabooth} />
                           {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                        ...
                        <div className="cat" style={{  textAlign: 'center', marginTop:'50px',marginBottom:'50px'}}>
                                    ...
                                    style={{  backgroundColor: '#37b546',borderRadius:'25px'}}>
                                          <ReactPhotoCollage {...settingWallskin} />
                                      {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                         ...
                         <ReactPhotoCollage {...settingCanvas} />
                                    {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                        ...
                        style={{
                            backgroundColor: '#f0d28a',borderRadius:'25px'
                                  ...
                                  <ReactPhotoCollage {...settingDiecut} />
                       {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                       Perfect solution if you're looking for something new to give away as party favours.
                        ...
                        style={{  backgroundColor: '#e70e22',borderRadius:'25px'}}>
                             <ReactPhotoCollage {...settingCarstickers} />
                    {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                  Make  a fun form of advertising, they rarely become out of date or out of fashion. In fact, they’re always evolving with time.
                        ...
                        style={{  backgroundColor: '#0c55c8',borderRadius:'25px'}}>
                              <ReactPhotoCollage {...settingFrosted} />
                                 {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                        ...
                        <div className="col-xl-2" >
                                    ...
                                    style={{  backgroundColor: '#04a617',borderRadius:'25px'}}>
                                           <ReactPhotoCollage {...settingVinyl} />
                                 {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
                                 Flexible, durable and affordable, vinyl stickers open the door to limitless creativity.
                                    ...
                                    style={{  backgroundColor: '#6b727e',borderRadius:'25px'}}>
                                        <ReactPhotoCollage {...settingReflect} />
