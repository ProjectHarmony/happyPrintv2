...
export default function AdvertisingDetailsArea() {
    const settingLogo = {
        ...
        photos: [
          ...
          { source: "/images/services/logo/logo1.jpg" },
          { source: "/images/services/logo/logo2.jpg" },
          { source: "/images/services/logo/logo3.jpg" },
          { source: "/images/services/logo/logo4.jpg" },
      ...
      const settingHead = {
        ...
        photos: [
          ...
          { source: "/images/services/letterhead/head1.jpg" },
          { source: "/images/services/letterhead/head2.jpg" },
          { source: "/images/services/letterhead/head3.jpg" },
          { source: "/images/services/letterhead/head4.jpg" },
      ...
      const settingMosaic = {
        ...
        photos: [
          ...
          { source: "/images/services/mosaic/mosaic1.jpg" },
          { source: "/images/services/mosaic/mosaic2.jpg" },
          { source: "/images/services/mosaic/mosaic3.png" },
                    ...
                    <div className="cat" style={{  textAlign: 'center', marginBottom:'50px'}}>
                      ...
                      Stand out from the crowd with a logo that fits your brand personality.
                        ...
                        style={{  backgroundColor: '#dc3545',borderRadius:'25px'}}>
                              <ReactPhotoCollage {...settingMosaic} />
                          {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
