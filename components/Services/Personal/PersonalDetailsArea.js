...
export default function AdvertisingDetailsArea() {
    const settingBox = {
        ...
        photos: [
          ...
          { source: "/images/services/dropbox/box1.jpg" },
          { source: "/images/services/dropbox/box2.jpg" },
          { source: "/images/services/dropbox/box3.jpg" },
          { source: "/images/services/dropbox/box4.jpg" },
      ...
      const settingMenu = {
        ...
        photos: [
          ...
          { source: "/images/services/menu/menu1.jpg" },
          { source: "/images/services/menu/menu2.jpg" },
          { source: "/images/services/menu/menu3.jpg" },
          { source: "/images/services/menu/menu4.jpg" },
      ...
      const settingStain = {
        ...
        photos: [
          ...
          { source: "/images/services/stainless/stain1.jpg" },
          { source: "/images/services/stainless/stain2.jpg" },
          { source: "/images/services/stainless/stain3.jpg" },
          { source: "/images/services/stainless/stain4.jpg" },
                        ...
                        <div className="col-xl-4">
                           ...
                           Stainless Design
                            ...
                            style={{  backgroundColor: '#37b546',borderRadius:'25px'}}>
                                   <ReactPhotoCollage {...settingStain} />
                                 {/* <Text h6 size={32} color="white" css={{ m: 0 }} style={{margin:'auto', width:'80%',textAlign:'center',marginTop:'40px'}}>
