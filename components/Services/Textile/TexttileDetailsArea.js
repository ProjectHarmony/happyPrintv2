...
export default function TexttileDetailsArea() {
    const backStyle = {
        color:'white'
    }
    const setting = {
        ...
        photos: [
          ...
          { source: "/images/services/tshirt/tshirt2.jpg" },
          { source: "/images/services/tshirt/tshirt3.jpg" },
          { source: "/images/services/tshirt/tshirt4.jpg" },
          { source: "/images/services/tshirt/tshirt1.jpg" },
                    ...
                    <div className="cat" style={{  textAlign: 'center', marginBottom:'50px'}}>
                        ...
                        >
                          <Card css={{ $$cardColor: '$colors$primary' }}>
                            ...
                            <Image src="/images/services/tshirt/tshirt4.jpg" alt="blog image"  width={300}
                        height={400} />
                            </Card.Body>
                        </Card>
