                    ...
                    <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px',marginTop: '68px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    ...
                                    <Avatar
                                    src="/images/employees/tagle.jpg"
                                    css={{ size: "$20" }}
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px',marginTop: '68px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/solon.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px',marginTop: '68px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/rullan.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px',marginTop: '68px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/cabudoc.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/villegas.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/alberto.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/barrios.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                            ...
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    ...
                                    <Avatar
                                     ...
                                     css={{ size: "$20" }}
                                     color="primary"
                                     src="/images/employees/decoloc.jpg"
                                     style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/abejero.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/librero.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/mercolita.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/sanlorenzo.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/gonzales.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
                        ...
                        <div className="col-xl-3 col-lg-6 col-md-6" style={{marginBottom:'60px'}}>
                            <div className="">
                                <div className="" style={styleAvatar}>
                                    {/* <img src="/images/employees/tagle.png" alt="" /> */}
                                    <Avatar
                                    src="/images/employees/clarito.jpg"
                                    style={{zIndex:'0', position:'relative!important',border:'9px solid white ',height:'90px',width:'90px',}}
                                    css={{ size: "$20" }}
                                    color="primary"
                                    // bordered
