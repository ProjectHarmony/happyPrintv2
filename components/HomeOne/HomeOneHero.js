...
export default function HomeOneHero() {
    ...
    const team = [
        ...
        {
            title: [<span style={{color:"white", fontSize:'54px'}}>We Fabricate</span>],
            // desc: "Magnificence in the realistic interchanges",
            // img: (
            //     <img
            //         src="/images/shape/hero-shape.png"
        ...
        {
            title: [<span style={{color:"white", fontSize:'54px'}}>We Personalize</span>],
            // desc: "Magnificence in the realistic interchanges",
            // img: (
            //     <img
            //         src="/images/shape/hero-shape.png"
        ...
        {
            title: [<span style={{color:"white",fontSize:'48px'}}><b>Highest Quality </b>Printing,<br></br> <b>Fastest Turn </b><br></br>Around</span>],
            // desc: "Magnificence in the realistic interchanges",
            // img: (
            //     <img
            //         src="/images/shape/hero-shape.png"
